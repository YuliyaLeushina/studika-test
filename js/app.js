(() => {
    ...
    window.addEventListener("resize", (() => {
        if (mql.matches) new core(".swiper", {
    ...
    da.init();
    const filtrItems = document.querySelectorAll(".filtr__item");
    document.addEventListener("click", (function(e) {
        const targetElement = e.target;
        if (targetElement.closest(".filtr__item")) {
            script_removeClasses(filtrItems, "_black");
            targetElement.closest(".filtr__item").classList.toggle("_black");
        }
    }));
    function script_removeClasses(elements, className) {
    ...
    priceCard.addEventListener("click", (function() {
        const items = document.querySelectorAll(".holder__row");
        const parent = document.getElementById("parent");
        const SortElements = new Object;
        items.forEach((function(item, indx) {
            const itemValue = parseInt(item.querySelector(".holder__num").textContent.replace("руб", "").replace(/\s+/g, ""));
